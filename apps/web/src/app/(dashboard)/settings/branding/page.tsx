...
export default function BrandingPage() {
  return <BrandingPageInner />;
}

function BrandingPageInner() {
  const [primaryColor, setPrimaryColor] = useState('#4F7BFF');
  const [accentColor, setAccentColor] = useState('#B06CFF');
  const [bgColor, setBgColor] = useState('#F8F6FF');
  const [logoText, setLogoText] = useState('Acme Corp');
  const [emailFrom, setEmailFrom] = useState('Acme Corp');
              ...
              <div className="space-y-5 p-6">
                <div className="grid grid-cols-2 gap-5">
                  <div>
                    ...
                    <p className="mt-1 text-xs" style={{ color: 'var(--text-muted)' }}>
                      Shown as "From: {emailFrom || 'Your name'}"
                    </p>
                  </div>
                  <div>
                    <label
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      Sent by {emailFrom} · Unsubscribe · {emailReply}
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    rows={2}
                    defaultValue="Acme Corp, 123 Market Street, San Francisco CA 94105"
            ...
            >
              <div className="space-y-5 p-6">
                <div>
                  ...
                  <input
                    type="text"
                    defaultValue="Welcome to Acme Corp"
                    className="w-full rounded-xl border px-3 py-2 text-sm outline-none"
                    style={{
                      borderColor: 'var(--border-default)',
                      background: 'var(--bg-main)',
                ...
                <div>
                  ...
                  <input
                    type="text"
                    defaultValue="Sign in to your workspace"
                    className="w-full rounded-xl border px-3 py-2 text-sm outline-none"
                    style={{
                      borderColor: 'var(--border-default)',
                      background: 'var(--bg-main)',
                ...
                <div>
                  ...
                  <textarea
                    rows={3}
                    defaultValue={`"riogentix has transformed how our team works. The SSO integration was seamless."\n— Sarah Chen, CTO at Momentum Labs`}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    defaultValue="Continue with Acme SSO"
                    className="w-full rounded-xl border px-3 py-2 text-sm outline-none"
                    style={{
                      borderColor: 'var(--border-default)',
                      background: 'var(--bg-main)',
